...
linkml_meta = LinkMLMeta({'default_prefix': 'shared',
     'default_range': 'string',
     'description': 'Shared identity entities used across multiple outcomes',
     ...
     'source_file': 'schemas/shared/identity.yaml'} )
...
class Actor(ProvenanceFields):
    ...
    name: Optional[str] = Field(default=None, description="""Full name""", json_schema_extra = { "linkml_meta": {'alias': 'name',
         'domain_of': ['Actor', 'Customer', 'Project'],
         'slot_uri': 'foaf:name'} })
